...
If you're reading this that means I'm looking for feedback! The following are a few stuff that I'd specifically like feedback on, though literally all of this is fair game. I just want to hear your thoughts, especially the critical ones!

- What looks badly/ inadequately designed or thought through?
- Specifically, what is your opinion on the construction system?
	- Is it sufficient to handle what you think will be thrown at it?
	- What can be done to improve it?
	- Sub grids as object children, as a subset of the world grid, or both?
- Thoughts on scope?
- Does anything seem out of place/ not contributing to game philosophy?
- Is it stupid to spend unfathomable amounts of time to basically give the average gamer access to version control on their save files when they more than likely won't use it, just because I want to prove it's possible?
	- (the correct answer to this one is "yes, but also now i'm curious")